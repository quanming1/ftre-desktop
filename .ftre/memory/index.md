...
| diff-view.md | Diff View (差异对比视图) | diff, diff view, MonacoDiffViewer, DiffBar, pendingDiffs, diffEntry, 差异对比, ftre://diff, DiffSummaryCard, DiffNavCard, unified diff, LCS 算法, parseUnifiedDiffLines, DiffLine, 自研组件, Tailwind CSS, React 19, prism-react-renderer |
...
| notification-stack.md | 消息弹窗 (Notification) | notification, toast, message, NotificationStack, NotificationCard, NotificationItem, 右下角弹窗, info, warning, error, autoDismissMs, bottom-right |
