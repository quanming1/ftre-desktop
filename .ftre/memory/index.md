...
| 文件 | 主题 | 关键词 |
|------|------|--------|
| chat-panel.md | Chat 面板 (AI 对话) | chat, ChatPanel, MessageList, ChatInput, message |
| session-panel.md | Session 面板 (会话管理) | session, SessionPanel, SessionSidebar, source, 分组, delete session, LayoutSwitcher, panelOrder, 面板管理, 拖拽排序 |
